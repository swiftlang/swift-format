...
extension BlankLineAfterFunctionDeclarationsTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__BlankLineAfterFunctionDeclarationsTests = [
        ("testIgnoreSingleLineFunction", testIgnoreSingleLineFunction),
        ("testIgnoreSuperCallsOnFirstLineFunction", testIgnoreSuperCallsOnFirstLineFunction),
        ("testInvalidBlankLineAfterFunction", testInvalidBlankLineAfterFunction),
        ("testMissingBlankLineAfterFunction", testMissingBlankLineAfterFunction),
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(BlankLineAfterFunctionDeclarationsTests.__allTests__BlankLineAfterFunctionDeclarationsTests),
