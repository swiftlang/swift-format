...
extension FileprivateAtFileScopeTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__FileprivateAtFileScopeTests = [
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(FileprivateAtFileScopeTests.__allTests__FileprivateAtFileScopeTests),
